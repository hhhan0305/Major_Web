...
function SpawnObstacle() {
  ...
  if (type == 1) {
    newObstacle.y -= dino.originalHeight - 10;
...
getJSON("https://api.openweathermap.org/data/2.5/weather?q=Antarctica&appid=df54b40e7c614cb48107fac285e16b9a&units=metric"
,
function(err,data){
  if(err != null){
